...
<head>
    ...
    <title>Update product for sale</title>
        ...
        <section>
            ...
            <?php
                ...
                if(isset($_POST["update_product"])){
                    ...
                    $update_query = "UPDATE `sale_product_data` SET 
                    `name`='$name',`description`='$description',`price`='$price',`dis_price`='$dis_price',`image`='$filename'
                    WHERE id=$idupdate"; 
                    ...
                    if($result){
                        ?>
                        <script>
                            window.location.href='viewsaleproducts.php';
                        </script>
                        <?php
                    }
                    ...
                    <div class="row">
                        <div class="col-6 offset-3 p-4 bg-white rounded">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="dis_price" class="form-control" value="<?php echo $data['dis_price'] ?>" required>
                            </div>
